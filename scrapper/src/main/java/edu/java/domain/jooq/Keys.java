...
public class Keys {
    ...
    public static final ForeignKey<SubscriptionsRecord, ChatRecord> CONSTRAINT_30 = Internal.createForeignKey(
    ...
    public static final ForeignKey<SubscriptionsRecord, LinkRecord> CONSTRAINT_303 = Internal.createForeignKey(
        Subscriptions.SUBSCRIPTIONS,
